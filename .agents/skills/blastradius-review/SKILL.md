---
name: blastradius-review
description: Review the architecture model against the code and report honestly. Use when asked to review this repository's architecture model.
---
