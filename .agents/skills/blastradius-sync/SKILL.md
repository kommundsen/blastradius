---
name: blastradius-sync
description: Bring the architecture model back in step with the code. Use when asked to update this repository's architecture model.
---
